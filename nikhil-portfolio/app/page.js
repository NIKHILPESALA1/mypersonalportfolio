    ...
    <section className="pt-32 pb-20 px-8 min-h-screen flex items-center">
      <div className="max-w-3xl mx-auto animate-fadeIn">
        ...
        <div className="flex gap-4 mb-8 flex-wrap">
          ...
          <SocialLink href="https://leetcode.com/NIKHILpesala" label="LeetCode"
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-10 animate-fadeIn">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://leetcode.com/NIKHILpesala" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-all transform hover:scale-105 text-sm font-medium">LeetCode</a>
            </div>
          </div>
        </div>
      </div>
